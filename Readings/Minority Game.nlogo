...
"" ""
PENS
"max" 1 0 -2674135 true "" "let max-score max [score] of turtles\nif (ticks != 0)[ plot max-score / ticks ]"
"min" 1 0 -13345367 true "" "let min-score min [score] of turtles\nif (ticks != 0)[ plot min-score / ticks ]"
"avg" 1 0 -10899396 true "" "if (ticks != 0)[ plot avg-score / ticks ]"
...
"max" 1 0 -2674135 true "" "let max-score max [score] of turtles\nplot max-score"
"min" 1 0 -13345367 true "" "let min-score min [score] of turtles\nplot min-score"
"avg" 1 0 -10899396 true "" "plot avg-score"
